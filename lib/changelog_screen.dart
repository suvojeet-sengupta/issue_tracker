        ...
        child: Column(
          ...
          children: [
            _buildChangelogEntry(
              ...
              'suvojit213',
              '2025-07-19 00:00:00',
              'chore: Update app version to 1.0.4',
            ),
            _buildChangelogEntry(
              context,
              '9a67088',
              'suvojit213',
              '2025-07-19 00:00:00',
              'feat: Add notification toggle to settings screen',
            ),
            _buildChangelogEntry(
              context,
              '8b4428d',
              'suvojit213',
              '2025-07-19 00:00:00',
              'feat: Implement clear all and swipe to clear notifications',
            ),
            _buildChangelogEntry(
              context,
              'f21121e',
              'suvojit213',
              '2025-07-19 00:00:00',
              'feat: Add dedicated access screen for enhanced security',
            ),
            _buildChangelogEntry(
              context,
              '1210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'feat: Implement password protection for initial setup and admin settings',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'feat: Enhance Google Form submission with dynamic data and improved UI',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'fix: Remove duplicated code and resolve syntax errors in issue_tracker_screen.dart',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'fix: Prevent bypassing access screen after initial setup',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'fix: Ensure consistent daily notifications by adjusting DailySchedulerWorker',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'refactor: Improve UI/UX of issue_tracker_screen.dart',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'refactor: Adjust floating navigation bar position for better visibility',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'refactor: Enhance dark theme visibility in issue_tracker_screen.dart',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'docs: Update README.md with new features and improvements',
            ),
            _buildChangelogEntry(
              context,
              'd210793',
              'suvojit213',
              '2025-07-19 00:00:00',
              'fix: Disable back navigation during Google Form submission',
            ),
            _buildChangelogEntry(
              context,
              'ccaa0ec',
