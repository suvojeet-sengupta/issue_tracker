      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildMotivePoint(context, 'Intuitive User Interface', 'A clean, modern, and easy-to-navigate design ensures a smooth user experience for all advisors.'),
            _buildMotivePoint(context, 'Automated Data Pre-filling', 'Say goodbye to repetitive typing. The app intelligently pre-fills relevant information into the Google Form, including user details, organization preference, and current date.'),
            _buildMotivePoint(context, 'Dynamic Team Leader Selection', 'Easily select your team leader from a predefined list or add a new one, ensuring accurate reporting hierarchies.'),
            _buildMotivePoint(context, 'Precise Issue Timing', 'Accurately log the start and end times of issues with a user-friendly time picker, providing comprehensive data for analysis.'),
            _buildMotivePoint(context, 'Persistent Preferences', 'The app remembers your organization (DISH/D2H) and other key details, minimizing setup time for subsequent issue reports.'),
